...
public enum Style {
    IMPRESSIONISM(
            "Impressionism is a painting style most" +
                    " commonly associated with the 19th century where small brush strokes are used to build up a larger picture."),
    ...
    REALISM("Also known as naturalism, this style of art is considered as" +
            " 'real art' and has been the dominant style of painting since the Renaissance.");
